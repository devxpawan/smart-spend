...
export const SkeletonCard = () => (
  <div className="group relative p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg bg-white border border-slate-200 min-h-[120px] sm:min-h-[140px]">
    <div className="animate-pulse flex flex-col h-full">
      <div className="flex items-start justify-between mb-3 sm:mb-4">
        ...
        <div className="w-12 h-12 rounded-lg bg-slate-200 flex-shrink-0 ml-2"></div>
      </div>
      <div className="mt-auto h-4 bg-slate-200 rounded w-1/4"></div>
    </div>
  </div>
);
...
export const SkeletonChart = () => (
  <div className="lg:col-span-3 bg-white p-4 sm:p-6 lg:p-8 rounded-lg sm:rounded-xl shadow-sm border border-gray-200">
    <div className="animate-pulse">
      ...
      <div className="h-64 sm:h-72 lg:h-80 bg-slate-200 rounded-lg"></div>
    </div>
  </div>
);
    ...
    <div className="animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col items-center">
          ...
          <div className="h-4 bg-slate-200 rounded w-20 mt-4"></div>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-48 h-48 rounded-full bg-slate-200"></div>
          <div className="h-4 bg-slate-200 rounded w-20 mt-4"></div>
